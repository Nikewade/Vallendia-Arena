...
public final class LineUtil implements Iterable<Block> {
	...
	public LineUtil(Location start, Location end, double offsetY) {
	...
	public LineUtil(Location start, Location end) {
		this(start, end, 0);
	}

	public LineUtil(LivingEntity start, Location end) {
