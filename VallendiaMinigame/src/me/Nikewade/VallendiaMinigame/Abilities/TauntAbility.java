...
public class TauntAbility implements Ability {
	int range = 10;
	int time = 10;
	boolean breakondmg = false;
	...
	public List<String> getDescription() {
		// TODO Auto-generated method stub
		return Arrays.asList("You taunt all enemies within a " + range + " block range,",
							"forcing them to look at you for " + time + " seconds. This",
	...
	for(Entity e: AbilityUtils.getAoeTargets(p, p.getLocation(), range, range, range))
	{

		LivingEntity target = (LivingEntity) e;
			
 			AbilityUtils.charm(p, target, "Charm Person", time * 20, breakondmg, true);
