...
public class WeakeningArrowsAbility implements Ability, Listener {
	...
	public List<String> getDescription() {
		// TODO Auto-generated method stub
		return Arrays.asList(chance + "% chance to weaken enemies for " + duration + " seconds.");
	}

	@Override
	public ItemStack getGuiItem() {
		// TODO Auto-generated method stub
		return Utils.getTippedArrowItemStack(PotionType.INSTANT_DAMAGE, 1, false, false, "");
	}
	...
	public boolean RunAbility(Player p) {
		...
		return false;
            ...
            public void onShootBow(EntityShootBowEvent e){
        		...
        		if(!VallendiaMinigame.getInstance().abilitymanager.playerHasAbility(p, "Weakening Arrows"))
        		{
        			return;
        		}
